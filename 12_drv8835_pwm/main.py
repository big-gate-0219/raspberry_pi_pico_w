...
def main():
    ...
    motorController = DCMotorController(Pin(M1_PIN, Pin.OUT), Pin(M2_PIN, Pin.OUT))    
    controller = PwmController(motorController, 10000, 90)
    
    controller.start()
    
    controller.move_forward()
    controller.duty_ratio(90)
    time.sleep(1)
    controller.duty_ratio(50)
    time.sleep(1)
    controller.duty_ratio(10)
    time.sleep(1)
